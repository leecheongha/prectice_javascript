...
console.log(arr1.every( e => e <40));//true 배열안의 모~든 원소가 40 미만인가?

console.log(arr1.every( e => e %2 == 0));//false

console.log([1, 30, 39, 29, 10, 13].every( e => e %2 == 0));//false

/**********************************************
 * 배열.some(판별함수)
 *  배열 안의 어떤 요소라도 주어진 판별 함수를 통과하는지 테스트한다. 단 하나만 통화해도 true가 나온다.
 * 
 *  판별함수의 리턴값은 Truthy / Falsy 를 리턴해야 한다
 * 
 *  판별함수의 매개변수 (element, index, array)
